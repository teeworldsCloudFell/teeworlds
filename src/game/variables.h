...
MACRO_CONFIG_INT(SvTimelimit, sv_timelimit, 0, 0, 1000, CFGFLAG_SERVER, "Time limit in seconds (0 disables)")
...
MACRO_CONFIG_INT(SvRegen, sv_regen, 0, 0, 100, CFGFLAG_SERVER, "Regeneration delay")
MACRO_CONFIG_INT(SvRegenHp, sv_regen_hp, 0, 10, 1000, CFGFLAG_SERVER, "Add hp per regeneration")
...
MACRO_CONFIG_INT(SvZombieHp, sv_zombie_hp, 0, 0, 5000, CFGFLAG_SERVER, "Zombie HP")
