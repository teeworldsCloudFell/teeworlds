...
MACRO_CONFIG_INT(SvGoTime, sv_go_time, 3, 0, 1000, CFGFLAG_SERVER, "Time before round restarts")
...
MACRO_CONFIG_INT(SvResetDetectsSeconds, sv_reset_detects_seconds, 120, 1, 6000, CFGFLAG_SERVER, "Seconds until detects get resetted to 0")
/* inQ */
