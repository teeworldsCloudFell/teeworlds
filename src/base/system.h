...
/*
	Function: str_replace
		Replaces a string inside another string case sensitive.

	Parameters:
		haystack - String to search in
		size - Size of the haystack
		needle - String to search for
		newneedle - String to replace with

	Returns:
		A integer which tells how many strings have been replaced.
